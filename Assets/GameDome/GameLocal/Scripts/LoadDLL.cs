...
namespace Test 
{
    ...
    public class LoadDLL : MonoBehaviour
    {
        ...
        [Header("使用 Application.streamingAssetsPath 作为路径")]
        ...
        {
            var path = $"{loadPath}/{asset}";

            if (useStreamingAssetsPath) path = $"{Application.streamingAssetsPath}/{asset}";
